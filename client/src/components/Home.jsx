                ...
                {homeData ? (
                    <div className="flex flex-wrap gap-x-1 gap-y-2 justify-center font-Lato md:gap-x-3 md:gap-y-4">
                        {homeData.map((file, i) => {
                            ...
                            return <div className="border-2 border-black w-[5rem] flex flex-col text-center break-words text-xl pt-2 pb-1 rounded-md bg-blue-900 p-[0.2rem] md:text-2xl md:pt-3 md:pb-2 md:w-[7rem]" key={file.data[0].img} onClick={() => navigate(`/${file.characterName}`)}>
